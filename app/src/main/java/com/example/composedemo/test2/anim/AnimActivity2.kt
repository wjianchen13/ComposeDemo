 ...
 * AnimatedVisibility
 */
class AnimActivity2 : ComponentActivity() {
...
@Composable
fun TestAnim2() {
    MainLayout2(modifier = Modifier.wrapContentSize(align = Alignment.TopStart))
}
...
@Composable
fun EditFab2(isExpand: Boolean, modifier: Modifier = Modifier) {
