 ...
 * animateColorAsState
 */
class AnimActivity9 : ComponentActivity() {
...
@Composable
fun TestLayout9() {
    SwitchButtonColor9(modifier = Modifier.wrapContentSize(align = Alignment.TopStart))
}

@Composable
fun SwitchButtonColor9(modifier: Modifier = Modifier) {
