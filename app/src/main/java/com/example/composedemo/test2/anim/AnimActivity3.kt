 ...
 * animateContentSize
 */
class AnimActivity3 : ComponentActivity() {
...
fun TestLayout3() {
    ...
    ExpandableText3(str, modifier = Modifier.wrapContentSize(align = Alignment.TopStart))
}

@Composable
fun ExpandableText3(text: String, modifier: Modifier = Modifier) {
